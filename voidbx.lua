...
local Config = {
    ...
    ESP = {
        ...
        Options = { 
            Teamcheck = true, TeamcheckRGB = Color3.fromRGB(0, 128, 0),
            Friendcheck = true, FriendcheckRGB = Color3.fromRGB(0, 128, 0),
            Highlight = false, HighlightRGB = Color3.fromRGB(128, 0, 0),
        },
        Drawing = {
            Chams = {
                Enabled  = false,
            ...
            Names = {
                Enabled = false,
                Transparency = 0,
                RGB = Color3.fromRGB(128, 128, 128),
            },
            Flags = {
                Enabled = false,
            },
            ...
            Weapons = {
                Enabled = false, WeaponTextRGB = Color3.fromRGB(119, 120, 128),
                Outlined = false,
                Gradient = false,
                Transparency = 0,
                GradientRGB1 = Color3.fromRGB(128, 128, 128), GradientRGB2 = Color3.fromRGB(119, 120, 128),
            },
            Inventory = {
...
Library:RefreshTheme("glow", Color3.fromRGB(0, 0, ))
